...
라이블 애플리케이션에 접속하세요. (iOS & Android)
좌우로 이동하며 끌리는 공연을 골라보세요.
끌리는 공연이 있다면 상하로 이동하여 해당 공연의 상세 정보를 보세요.
화면 하단의 초록색 티켓 버튼을 눌러 자신의 티켓 리스트에 추가하세요.
화면 좌측 상단의 티켓 리스트를 현장에서 검수원에게 보여주시고 바로 입장하시면 됩니다.
